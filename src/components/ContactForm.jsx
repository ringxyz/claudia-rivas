...
export default function ContactForm({en}){
 const [status,setStatus]=useState(''),[fallbackHref,setFallbackHref]=useState(''),[busy,setBusy]=useState(false);
 ...
 const submit=async(e)=>{
  ...
  const payload=Object.fromEntries(data);delete payload.website;delete payload.formStartedAt;payload._captcha='true';payload._template='table';payload._subject=`${en?'New proposal from':'Nueva propuesta de'} ${payload.name}`;payload._replyto=payload.email;
