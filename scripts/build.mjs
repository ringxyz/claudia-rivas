...
for(const lang of ['es','en']){const en=lang==='en',path=en?'en/':'';const title=en?'Claudia Rivas Miami | Entrepreneur, model & Claud 360 host':'Claudia Rivas Miami | Empresaria, modelo y host de Claud 360';const description=en?'Meet Claudia Rivas in Miami: entrepreneur, model, CEO of Enterprises Business Corp and host of Claud 360.':'Conoce a Claudia Rivas en Miami: empresaria, modelo, CEO de Enterprises Business Corp y host de Claud 360.';let seo=`<meta name="description" content="${description}"><meta name="keywords" content="Claudia Rivas, Claudia Rivas Miami, empresaria Miami, modelo Miami, Claud 360, Enterprises Business Corp"><meta property="og:title" content="${title}"><meta property="og:description" content="${description}"><meta property="og:type" content="website"><meta name="twitter:card" content="summary_large_image">`;if(site){const url=site+base;seo+=`<link rel="canonical" href="${url+path}"><link rel="alternate" hreflang="es" href="${url}"><link rel="alternate" hreflang="en" href="${url}en/"><link rel="alternate" hreflang="x-default" href="${url}"><meta property="og:url" content="${url+path}"><meta property="og:image" content="${url}media/portrait.webp">`;}else seo+='<meta name="robots" content="noindex, nofollow">';seo+=`<script type="application/ld+json">${JSON.stringify({'@context':'https://schema.org','@graph':[{'@type':'Person',name:'Claudia Rivas',jobTitle:en?'Entrepreneur, model and host':'Empresaria, modelo y host',sameAs:['https://www.instagram.com/claudiarivasm/','https://www.youtube.com/@Claud360'],worksFor:{'@type':'Organization',name:'Enterprises Business Corp',sameAs:'https://www.instagram.com/enterprisesbusinesscorp/'}},{'@type':'WebSite',name:'Claudia Rivas',inLanguage:lang,keywords:en?'Claudia Rivas Miami, entrepreneur, model, Claud 360':'Claudia Rivas Miami, empresaria, modelo, Claud 360',...(site?{url:site+base+path}:{})}]})}</script>`;await mkdir(`dist/${path}`,{recursive:true});await writeFile(`dist/${path}index.html`,template.replace('lang="es"',`lang="${lang}"`).replace('<title>Claudia Rivas</title>',`<title>${title}</title>`).replace('<!--seo-->',seo).replace('<div id="root"></div>',`<div id="root">${render(lang)}</div>`));}
